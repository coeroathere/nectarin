...
(lib.Символ7копия = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AgmBFQgJAAgFgGQgGgEAAgIIAAhlQAAgJAGgEQAFgFAJABIBNAAQAJgBAGAFQAFAEAAAJIAABlQAAAIgFAEQgGAGgJAAgAgIAiIASAAIAAhDIgSAAg");
	this.shape.setTransform(151.4,17);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AAKBFIAAg2IgTAAIAAA2IgxAAIAAiIIAxAAIAAAxIATAAIAAgxIAxAAIAACIg");
	this.shape_1.setTransform(137.8,17);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AAKBFIAAgSIAHgsIgDAAIgXAwIAAAOIgxAAIAAiIIAxAAIAAARIgHAsIADAAIAXgwIAAgNIAxAAIAACIg");
	this.shape_2.setTransform(124.2,17);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AALBFIgMg2IgJAAIAAA2IgxAAIAAiIIAxAAIAAAxIAJAAIALgxIAuAAIAAARIgSAvIAWA2IAAASg");
	this.shape_3.setTransform(110.9,17);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("Ag6BFIAAiIIBhAAQAKgBAFAFQAFAEAAAJIAAAfQAAAIgGAEQgGAEgIAAIAAADQAIAAAGAFQAGAEAAAIIAAAiQAAAIgFAEQgFAGgKAAgAgIAiIASAAIAAgTIgSAAgAgIgSIASAAIAAgPIgSAAg");
	this.shape_4.setTransform(86.4,17);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("Ag0BFIAAiIIBpAAIAAARIgIARIgwAAIAAAPIAwAAIAAAhIgwAAIAAATIA4AAIAAAjg");
	this.shape_5.setTransform(62.8,17);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AAsBFIgMg2IgIAAIAAA2IgvAAIAAg2IgIAAIgMA2IgyAAIAAgSIAWg2IgSgvIAAgRIAvAAIALAxIAIAAIAAgxIAvAAIAAAxIAIAAIALgxIAvAAIAAARIgSAvIAWA2IAAASg");
	this.shape_6.setTransform(46.8,17);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("AgZBFIAAgSIAHgPIgphWIAAgRIAvAAIAMA1IAFAAIAKg1IAtAAIAAARIgqB3g");
	this.shape_7.setTransform(30.7,17);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ7копия, new cjs.Rectangle(22.4,3.6,138.1,26), null);
...
(lib.Символ7 = function(mode,startPosition,loop) {
	...
	// Слой 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AgoBIQgJAAgGgFQgGgFAAgIIAAhrQAAgIAGgFQAGgFAJAAIBRAAQAJAAAGAFQAGAFAAAIIAABrQAAAIgGAFQgGAFgJAAgAgJAkIATAAIAAhHIgTAAg");
	this.shape.setTransform(162.1,12.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AAKBIIAAg4IgUAAIAAA4IgzAAIAAiPIAzAAIAAA0IAUAAIAAg0IA0AAIAACPg");
	this.shape_1.setTransform(147.8,12.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AAKBIIAAgSIAIguIgEAAIgYAxIAAAPIgzAAIAAiPIAzAAIAAASIgHAuIAEAAIAXgxIAAgPIA0AAIAACPg");
	this.shape_2.setTransform(133.6,12.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AAMBIIgOg4IgJAAIAAA4IgzAAIAAiPIAzAAIAAA0IAJAAIAMg0IAxAAIAAASIgTAyIAXA5IAAASg");
	this.shape_3.setTransform(119.7,12.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("Ag9BIIAAiPIBmAAQAJAAAGAFQAGAFAAAIIAAAhQAAAIgHAFQgGAEgJAAIAAADQAJAAAGAFQAHAFAAAIIAAAkQAAAIgGAFQgGAFgJAAgAgJAkIATAAIAAgUIgTAAgAgJgTIATAAIAAgQIgTAAg");
	this.shape_4.setTransform(94,12.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#000000").s().p("Ag2BIIAAiPIBtAAIAAASIgIASIgyAAIAAAQIAyAAIAAAjIgyAAIAAAUIA6AAIAAAkg");
	this.shape_5.setTransform(69.5,12.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#000000").s().p("AAvBIIgOg4IgHAAIAAA4IgzAAIAAg4IgHAAIgNA4Ig1AAIAAgSIAYg5IgTgyIAAgSIAwAAIANA0IAHAAIAAg0IAzAAIAAA0IAHAAIAMg0IAyAAIAAASIgUAyIAXA5IAAASg");
	this.shape_6.setTransform(52.7,12.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000000").s().p("AgaBIIAAgSIAGgQIgqhbIAAgSIAyAAIAMA4IAFAAIAKg4IAwAAIAAASIgtB9g");
	this.shape_7.setTransform(35.9,12.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Символ7, new cjs.Rectangle(27.1,-1.8,144.4,27.2), null);
...
(lib.scale_center3 = function(mode,startPosition,loop) {
	...
	this.DP.parent = this;
	this.DP.setTransform(131.9,292.1,0.246,0.246,0,0,0,226.3,125.5);
	this.DP._off = true;

	this.timeline.addTween(cjs.Tween.get(this.DP).wait(15).to({_off:false},0).to({regX:225.8,regY:125.3,scaleX:0.68,scaleY:0.68,x:133,y:237.7},11,cjs.Ease.get(1)).wait(18).to({regY:125.2,scaleX:0.63,scaleY:0.63,x:132.9,y:237.8},4,cjs.Ease.get(1)).to({regY:125.3,scaleX:0.68,scaleY:0.68,x:133,y:237.7},4,cjs.Ease.get(1)).wait(198));
...
p.nominalBounds = new cjs.Rectangle(-1282.2,-104.9,2724.6,505);
...
(lib.scale_center2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(44).to({regX:56.7,regY:57.3,scaleX:0.09,scaleY:0.09},4,cjs.Ease.get(1)).to({regX:56.9,regY:56.9,scaleX:0.1,scaleY:0.1},4,cjs.Ease.get(1)).wait(198));
	...
	this.DP = new lib.Символ3();
	this.DP.parent = this;
	this.DP.setTransform(118.8,214.4,0.307,0.307,0,0,0,226.3,125.3);
	this.DP._off = true;
	...
	this.button = new lib.Символ6();
	this.button.parent = this;
	this.button.setTransform(251.4,195.3,0.114,0.114,0,0,0,137.3,20.6);
...
(lib.scale_center = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.DP).wait(15).to({_off:false},0).to({regX:226,scaleX:1,scaleY:1,x:-90,y:125},11,cjs.Ease.get(1)).wait(18).to({regX:225.9,regY:125.1,scaleX:0.93,scaleY:0.93,x:-79.8,y:125.4},4,cjs.Ease.get(1)).to({regX:226,regY:125,scaleX:1,scaleY:1,x:-90,y:125},4,cjs.Ease.get(1)).wait(198));
